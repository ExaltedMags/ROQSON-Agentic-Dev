...
doc = {
    ...
    "name": "Trip Ticket In Transit -> Sales",
...
try:
    roqson.update_doc("Server Script", "Trip Ticket In Transit -> Sales", doc)
    print("Updated Trip Ticket In Transit -> Sales")
except Exception:
    r = requests.post("https://roqson-industrial-sales.s.frappe.cloud/api/resource/Server Script", json=doc, headers=headers)
    print("Created Trip Ticket In Transit -> Sales:", r.status_code)
