...
list_script = """
// Sales List Script - No Truncation Horizontal Scroll
...
// ── Column width definitions (These are now MINIMUM widths) ───────
const SALES_COL_WIDTHS = {
    "sales-col-id":          "140px",
    "sales-col-status":      "130px",
    "sales-col-customer":    "260px",
    "sales-col-address":     "350px",
...
function style_all_columns(page) {
    ...
    function applyColWidth(col, cls) {
        ...
        // Let it grow naturally to fit content without truncating
        col.style.setProperty("flex", "0 0 auto", "important");
        col.style.setProperty("min-width", w, "important");
        col.style.setProperty("max-width", "none", "important"); // No max width!
...
print("Updated List Script with absolute no-truncation logic.")
