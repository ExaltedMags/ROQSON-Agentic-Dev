...
# Enforces Trip Ticket delivery sequencing and syncs Sales status only after final workflow transitions
...
new_wf = workflow_state
sales_target_status = ""

if old_wf != "Received" and new_wf == "Received" and delivery_status == "Successful":
    sales_target_status = "Received"
elif old_wf != "Failed" and new_wf == "Failed" and delivery_status == "Failed":
