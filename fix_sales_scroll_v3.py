...
list_script = """
// Sales List Script - Horizontal Scroll Fix
...
function style_all_columns(page) {
    ...
    function applyColWidth(col, cls) {
        ...
        col.style.setProperty("padding-left", "8px");
        col.style.setProperty("padding-right", "8px");
        col.style.setProperty("box-sizing", "border-box");
        ...
        if (cls === "sales-col-status") {
            ...
            col.style.setProperty("overflow", "hidden");
            col.style.setProperty("text-overflow", "ellipsis");
            col.style.setProperty("white-space", "nowrap");
        }
    }
        ...
        if (!listview.page.fields_dict.address_filter) {
            listview.page.add_field({
                ...
                change: function() {
                    ...
                    // Re-apply filters to clear the empty state bug
...
try:
    ...
    print("Updated List Script with robust horizontal scroll logic.")
